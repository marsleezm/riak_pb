...
msg_type(94) -> fpbstarttxreq;
msg_type(95) -> fpbstarttxresp;
msg_type(96) -> fpbupdatereq;
msg_type(97) -> fpbupdateresp;
msg_type(98) -> fpbreadreq;
msg_type(99) -> fpbreadresp;
msg_type(100) -> fpbcommittxreq;
msg_type(101) -> fpbcommittxresp;
msg_type(102) -> txid;
...
msg_code(fpbstarttxreq) -> 94;
msg_code(fpbstarttxresp) -> 95;
msg_code(fpbupdatereq) -> 96;
msg_code(fpbupdateresp) -> 97;
msg_code(fpbreadreq) -> 98;
msg_code(fpbreadresp) -> 99;
msg_code(fpbcommittxreq) -> 100;
msg_code(fpbcommittxresp) -> 101;
msg_code(txid) -> 102;
...
decoder_for(94) -> clocksi_pb;
decoder_for(95) -> clocksi_pb;
decoder_for(96) -> clocksi_pb;
decoder_for(97) -> clocksi_pb;
decoder_for(98) -> clocksi_pb;
decoder_for(99) -> clocksi_pb;
decoder_for(100) -> clocksi_pb;
decoder_for(101) -> clocksi_pb;
decoder_for(102) -> clocksi_pb;
